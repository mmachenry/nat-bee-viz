...
var _mmachenry$nat_bee_viz$BeeTrip$BeeTrip = F3(
	function (a, b, c) {
		return {uid: a, start: b, end: c};
	});

var _mmachenry$nat_bee_viz$DrawBee$splitTripsOfDayBreak = function (trips) {
	var setTime = F2(
		function (date, _p0) {
			var _p1 = _p0;
			return A2(
				_elm_community$elm_time$Time_DateTime$setMillisecond,
				_p1._3,
				A2(
					_elm_community$elm_time$Time_DateTime$setSecond,
					_p1._2,
					A2(
						_elm_community$elm_time$Time_DateTime$setMinute,
						_p1._1,
						A2(_elm_community$elm_time$Time_DateTime$setHour, _p1._0, date))));
		});
	var endOfDay = {ctor: '_Tuple4', _0: 23, _1: 59, _2: 59, _3: 999};
	var startOfDay = {ctor: '_Tuple4', _0: 0, _1: 0, _2: 0, _3: 0};
	var splitTrip = function (trip) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_community$elm_time$Time_DateTime$date(trip.start),
			_elm_community$elm_time$Time_DateTime$date(trip.end)) ? {
			ctor: '::',
			_0: trip,
			_1: {ctor: '[]'}
		} : {
			ctor: '::',
			_0: A3(
				_mmachenry$nat_bee_viz$BeeTrip$BeeTrip,
				trip.uid,
				trip.start,
				A2(setTime, trip.start, endOfDay)),
			_1: {
				ctor: '::',
				_0: A3(
					_mmachenry$nat_bee_viz$BeeTrip$BeeTrip,
					trip.uid,
					A2(setTime, trip.end, startOfDay),
					trip.end),
				_1: {ctor: '[]'}
			}
		};
	};
	return A2(_elm_lang$core$List$concatMap, splitTrip, trips);
};
var _mmachenry$nat_bee_viz$DrawBee$timeToAngle = function (_p2) {
	var _p3 = _p2;
	var secondsPerDay = (24 * 60) * 60;
	var secondsIntoDay = (((_p3._0 * 60) + _p3._1) * 60) + _p3._2;
	var timeRatio = _elm_lang$core$Basics$toFloat(secondsIntoDay) / _elm_lang$core$Basics$toFloat(secondsPerDay);
	var radians = (timeRatio * 2) * _elm_lang$core$Basics$pi;
	var reversed = (2 * _elm_lang$core$Basics$pi) - radians;
	return (_elm_lang$core$Native_Utils.cmp(reversed, (3 / 2) * _elm_lang$core$Basics$pi) > -1) ? (reversed - ((3 / 2) * _elm_lang$core$Basics$pi)) : (reversed + (_elm_lang$core$Basics$pi / 2));
};
var _mmachenry$nat_bee_viz$DrawBee$diffDays = F2(
	function (d1, d2) {
...
var _mmachenry$nat_bee_viz$DrawBee$centerY = 300;
var _mmachenry$nat_bee_viz$DrawBee$centerX = 300;
var _mmachenry$nat_bee_viz$DrawBee$polarToCartesian = function (_p4) {
	...
	return {
		ctor: '_Tuple2',
		_0: _mmachenry$nat_bee_viz$DrawBee$centerX + (_p7 * _elm_lang$core$Basics$cos(_p6)),
		_1: _mmachenry$nat_bee_viz$DrawBee$centerY - (_p7 * _elm_lang$core$Basics$sin(_p6))
	};
};
var _mmachenry$nat_bee_viz$DrawBee$describeArc = function (arc) {
...
var _mmachenry$nat_bee_viz$DrawBee$ArcData = F3(
	function (a, b, c) {
		return {numDay: a, startAngle: b, endAngle: c};
	});
var _mmachenry$nat_bee_viz$DrawBee$tripToArcData = F2(
	function (startDate, trip) {
		var timeTuple = function (t) {
			return {
				ctor: '_Tuple3',
				_0: _elm_community$elm_time$Time_DateTime$hour(t),
				_1: _elm_community$elm_time$Time_DateTime$minute(t),
				_2: _elm_community$elm_time$Time_DateTime$second(t)
			};
		};
		return A3(
			_mmachenry$nat_bee_viz$DrawBee$ArcData,
			A2(
				_mmachenry$nat_bee_viz$DrawBee$diffDays,
				_elm_community$elm_time$Time_DateTime$date(trip.start),
				startDate),
			_mmachenry$nat_bee_viz$DrawBee$timeToAngle(
				timeTuple(trip.start)),
			_mmachenry$nat_bee_viz$DrawBee$timeToAngle(
				timeTuple(trip.end)));
	});
...
var _mmachenry$nat_bee_viz$DrawBee$drawConcentricCircles = function (trips) {
	return A2(
		_elm_lang$core$List$map,
		_mmachenry$nat_bee_viz$DrawBee$describeArc,
		_mmachenry$nat_bee_viz$DrawBee$tripsToArcData(
			_mmachenry$nat_bee_viz$DrawBee$splitTripsOfDayBreak(trips)));
};

var _mmachenry$nat_bee_viz$ParseBee$listAt = F2(
	function (i, l) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, i, l));
	});
var _mmachenry$nat_bee_viz$ParseBee$parseDateAndTime = F2(
	function (dateStr, timeStr) {
		return _elm_community$elm_time$Time_DateTime$fromISO8601(
			A2(
				_elm_lang$core$Basics_ops['++'],
				dateStr,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'T',
					A2(_elm_lang$core$Basics_ops['++'], timeStr, 'Z'))));
	});
var _mmachenry$nat_bee_viz$ParseBee$parseDateAndTimeFrom = F3(
	function (row, dateIndex, timeIndex) {
		return A2(
			...
			function (date) {
				return A2(
					_elm_lang$core$Result$andThen,
					function (time) {
						return A2(_mmachenry$nat_bee_viz$ParseBee$parseDateAndTime, date, time);
					},
					A2(
						_elm_lang$core$Result$fromMaybe,
						'out of bounds',
						A2(_mmachenry$nat_bee_viz$ParseBee$listAt, timeIndex, row)));
			},
			A2(
				_elm_lang$core$Result$fromMaybe,
				'out of bounds',
				A2(_mmachenry$nat_bee_viz$ParseBee$listAt, dateIndex, row)));
	});
var _mmachenry$nat_bee_viz$ParseBee$rowToBeeTrip = function (row) {
	return A2(
		_elm_lang$core$Result$andThen,
		function (uid) {
			return A2(
				...
				function (start) {
					return A2(
						...
						function (end) {
							return _elm_lang$core$Result$Ok(
								A3(_mmachenry$nat_bee_viz$BeeTrip$BeeTrip, uid, start, end));
						},
						A3(_mmachenry$nat_bee_viz$ParseBee$parseDateAndTimeFrom, row, 2, 3));
				},
				A3(_mmachenry$nat_bee_viz$ParseBee$parseDateAndTimeFrom, row, 5, 4));
		},
		A2(
			_elm_lang$core$Result$fromMaybe,
			'out of bounds',
			A2(_mmachenry$nat_bee_viz$ParseBee$listAt, 1, row)));
};
var _mmachenry$nat_bee_viz$ParseBee$parseBeeData = function (inputStr) {
	var csvData = A2(_lovasoa$elm_csv$Csv$parseWith, ',', inputStr);
	return _elm_community$result_extra$Result_Extra$combine(
		A2(_elm_lang$core$List$map, _mmachenry$nat_bee_viz$ParseBee$rowToBeeTrip, csvData.records));
};

var _mmachenry$nat_bee_viz$Main$documentation = A2(
	...
	{ctor: '[]'},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('\"\",\"Date_PST\",\"Time_end\",\"Time_start\",\"Date_PST_start\",\"overnight\",\"guarding\",\"pforage\",\"prob.sanitation\"'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _mmachenry$nat_bee_viz$Main$parseErrorDisplay = function (str) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], 'Parser error: ', str)),
			_1: {ctor: '[]'}
		});
};
var _mmachenry$nat_bee_viz$Main$tableView = function (model) {
	var makeCell = function (date) {
		return A2(
	...
	var makeRow = function (trip) {
		return A2(
			_elm_lang$html$Html$tr,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: makeCell(trip.start),
				_1: {
					ctor: '::',
					_0: makeCell(trip.end),
					_1: {ctor: '[]'}
				}
			});
	};
	return A2(
		_elm_lang$html$Html$table,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'border', _1: '1'},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_1: A2(_elm_lang$core$List$map, makeRow, model.beeTrips)
		});
};
var _mmachenry$nat_bee_viz$Main$imageView = function (model) {
	return A2(
		...
		_mmachenry$nat_bee_viz$DrawBee$drawConcentricCircles(model.beeTrips));
};
		...
		switch (_p0.ctor) {
			...
			case 'CSVSelected':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _mmachenry$nat_bee_viz$Main$fileSelected('CSVInput')
				};
			default:
				var _p2 = _p0._0;
...
var _mmachenry$nat_bee_viz$Main$CSVPortData = F2(
	function (a, b) {
...
var _mmachenry$nat_bee_viz$Main$Table = {ctor: 'Table'};
...
var _mmachenry$nat_bee_viz$Main$subscriptions = function (model) {
	return _mmachenry$nat_bee_viz$Main$fileContentRead(_mmachenry$nat_bee_viz$Main$CSVParse);
};
var _mmachenry$nat_bee_viz$Main$CSVSelected = {ctor: 'CSVSelected'};
var _mmachenry$nat_bee_viz$Main$editView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html_Events$on,
								'change',
								_elm_lang$core$Json_Decode$succeed(_mmachenry$nat_bee_viz$Main$CSVSelected)),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'color',
								_1: _elm_lang$core$Native_Utils.eq(tab, _p6) ? 'grey' : 'white'
							},
							_1: {
								ctor: '::',
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$disabled(
						_elm_lang$core$Native_Utils.eq(tab, _p6)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_mmachenry$nat_bee_viz$Main$ChangeTab(_p6)),
						_1: {ctor: '[]'}
					}
				}
			},
		...
		A2(
			...
			makeButton,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _mmachenry$nat_bee_viz$Main$Table, _1: 'Table'},
						_1: {ctor: '[]'}
					}
				}
			}));
};
var _mmachenry$nat_bee_viz$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _mmachenry$nat_bee_viz$Main$documentation,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _mmachenry$nat_bee_viz$Main$buttonBar(model.currentTab),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: function () {
								var _p7 = model.currentTab;
								switch (_p7.ctor) {
									case 'Edit':
										return _mmachenry$nat_bee_viz$Main$editView(model);
									case 'Table':
										return _mmachenry$nat_bee_viz$Main$tableView(model);
									default:
										return _mmachenry$nat_bee_viz$Main$imageView(model);
								}
							}(),
							_1: {ctor: '[]'}
						}),
...
var _mmachenry$nat_bee_viz$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _mmachenry$nat_bee_viz$Main$initModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: _mmachenry$nat_bee_viz$Main$view,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mmachenry$nat_bee_viz$Main$main !== 'undefined') {
    _mmachenry$nat_bee_viz$Main$main(Elm['Main'], 'Main', undefined);
}
